...
contract PESTokenUpgradeable is Initializable, ERC20Upgradeable, OwnableUpgradeable, PausableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(address initialOwner, address initialLiquidityWallet, address initialOperationsWallet)
        public
        initializer
    {
        if (
